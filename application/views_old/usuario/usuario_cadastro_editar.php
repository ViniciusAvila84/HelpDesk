...
<div class="content">
  ...
  <div class= "col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    ...
    <div class="col-md-12">
      ...
      <form class="form" action="<?=base_url()?>index.php/usuario/atualizar_salvar" method="post" enctype="multipart/form-data">
...
<!--        <div class="row">
        ...
        <div class="col-md-5">
          <div class="form-group">
            ...
            <input type="number" class="form-control" id="habilidades" name="telefone_fixo" placeholder="" value="<?= $usuario[0]->TELEFONE_FIXO;?>">
          </div>
        </div>
      </div>  
        ...
        <div class="col-md-5">
          <div class="form-group">
            ...
            <input type="number" class="form-control" id="habilidades" name="telefone_celular" placeholder="" value="<?= $usuario[0]->TELEFONE_CELULAR;?>">
          </div>
        </div>
      </div>  
        ...
        <div class="col-md-5">
          <div class="form-group">
            ...
            <input type="habilidades" class="form-control" id="habilidades" name="ramal" placeholder="" value="<?= $usuario[0]->RAMAL;?>">
          </div>
        </div>
      </div>  
