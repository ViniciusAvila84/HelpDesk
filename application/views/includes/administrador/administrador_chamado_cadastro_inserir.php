<form name="form1" class="form" action="<?=base_url()?>index.php/chamado/administrador_insert" enctype="multipart/form-data" method="post">
		...
		<div class="row">
			<div class="col-md-6">
				<label for="nivel">Usuario</label>
					<select id="empresa" class="form-control" name="fk_id_usuario">
						<option value="0">--- </option>
                        <?php foreach ($usuarios as $usuario){?>
                        <option value="<?= $usuario->PK_ID_USUARIO ?>"> <?= $usuario->NOME;?> </option>
                        <?php } ?>
					</select>
			</div>
		</div>
