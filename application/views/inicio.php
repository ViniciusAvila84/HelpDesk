...
?>
		...
		<div class="row">
	  		<div class= "col-md-12">
	    		<h2 class= "page-header">
					...
					<a href="<?= base_url()?>index.php/chamado/administrador_criar_chamado" class="btn-success pull-right"><i class="fa fa-creative-commons fa-2x"></i></a>
		...
		<div class="row">
			...
			<div class= "col-md-4 border border-primary">
			<h4><a href="<?= base_url()?>index.php/inicio/indexematendimento">Em andamento </a><span class="badge badge-secondary"><?php echo $ematendimento; ?></span></h4>
			</div>		
			<div class= "col-md-4 border border-primary">
